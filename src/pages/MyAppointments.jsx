      ...
      <div>
        {doctors.slice(0,2).map((item,index) => (
          ...
          <div className='flex-1 text-sm text-zinc-600'>
            ...
            <p className='text-xs '>{item.address.lane1}</p>
            <p className='text-xs '> {item.address.lane2}</p>
            <p className='text-xs mt-1'><span className='text-sm text-neutral-600 font-medium'>Date & Time:</span> 2</p>
          </div>
          <div></div>
